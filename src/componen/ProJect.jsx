  ...
  return (
    <div name="project" className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen ">
      <div className="max-w-screen-lg  mx-auto flex flex-col justify-center w-full h-full p-4">
        <div className="mt-32">
          <span className="border-b-4 border-gray-500 inline text-4xl font-bold uppercase bg-gradient-to-l text-transparent bg-clip-text from-sky-600 to-teal-500 font-inter2">project</span>
        </div>
        <div className="grid ">
